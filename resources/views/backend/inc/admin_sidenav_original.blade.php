<div class="aiz-sidebar-wrap">
 ...
 <!-- Refund addon -->
                ...
                <!-- Alibaba Dropshipping Module -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('alibaba.dashboard') }}" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zM5.5 6.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM11 6.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM5 10.5c.5.125 1.25.375 3 .375s2.5-.25 3-.375" fill="#575b6a"/>
                            </svg>
                        </div>

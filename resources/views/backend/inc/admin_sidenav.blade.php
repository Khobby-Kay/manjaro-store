 ...
 <!-- Refund addon -->
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <!-- Mobile Money Callback Monitor -->
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('mobile_money.admin.callback.monitor') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Mobile Money Callback Monitor')}}</span>
                            </a>
                        </li>
                        
                        <!-- Prudential Bank Callback Monitor -->
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('prudential.admin.callback.monitor') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Prudential Bank Callback Monitor')}}</span>
                            </a>
                        </li>
                ...
                @canany(['view_staff_activity', 'view_staff_activity_dashboard'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <path d="M8 0C3.58 0 0 3.58 0 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z" fill="#575b6a"/>
                                <path d="M8 2C4.69 2 2 4.69 2 8s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z" fill="#575b6a"/>
                                <circle cx="8" cy="8" r="2" fill="#575b6a"/>
                            </svg>
                        </div>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @can('view_staff_activity_dashboard')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('staff_activity_logs.dashboard')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Dashboard')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_staff_activity_logs')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('staff_activity_logs.logs')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Activity Logs')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_staff_activity_users')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('staff_activity_logs.users')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('User Reports')}}</span>
                            </a>
                        </li>
                        @endcan
                    </ul>
                ...
                <!-- Alibaba Integration -->
                @canany(['alibaba_management', 'alibaba_dashboard'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Alibaba Integration')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        @can('alibaba_dashboard')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('alibaba.dashboard')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Dashboard')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('alibaba_settings')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('alibaba.settings')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Settings')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('alibaba_suppliers')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('alibaba.suppliers.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Suppliers')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('alibaba_products')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('alibaba.products.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Products')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('alibaba_orders')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('alibaba.orders.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Orders')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('alibaba_import_logs')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('alibaba.import-logs.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Import Logs')}}</span>
                            </a>
                        </li>
                        @endcan
                    </ul>

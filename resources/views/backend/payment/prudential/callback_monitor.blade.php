    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{ translate('Prudential Bank Callback Monitor') }}</h5>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="alert alert-info">
                            <strong>Callback URL:</strong> {{ url('/prudential/callback') }}<br>
                            <strong>Admin Test URL:</strong> {{ url('/prudential/admin/callback/test') }}<br>
                            <strong>Monitor URL:</strong> {{ url('/prudential/admin/callback/monitor') }}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h6>Quick Actions</h6>
                        <a href="{{ route('prudential.admin.callback.test') }}" class="btn btn-primary btn-sm">
                            <i class="las la-play"></i> Test Callback
                        </a>
                        <a href="{{ route('prudential.admin.callback.monitor') }}" class="btn btn-info btn-sm">

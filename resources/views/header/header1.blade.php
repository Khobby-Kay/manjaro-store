    ...
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <!-- Mobile: Hamburger menu with "All" text (both clickable) -->
                <div class="d-lg-none d-flex align-items-center mr-3 mr-sm-4">
                    <button type="button" class="btn p-0 active" data-toggle="class-toggle"
                    ...
                    <button type="button" class="btn p-0 ml-2 fs-14 fw-600" style="color: {{ $middleHeaderTextColor }}; background: none; border: none;" data-toggle="class-toggle" data-target=".aiz-top-menu-sidebar">All</button>
                </div>
                <!-- Header Logo -->

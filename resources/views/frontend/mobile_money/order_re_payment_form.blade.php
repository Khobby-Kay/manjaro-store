<div class="mobile-money-payment-container">
    <div class="text-center">
        <h3>{{ translate('Mobile Money Order Re-payment') }}</h3>
        <p>{{ translate('Complete your order payment using Mobile Money') }}</p>
    </div>

    <div class="payment-form-container">
        <form id="mobile-money-order-repayment-form" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="remarks" name="remarks" 
                       value="Order Re-payment - Order #{{ $order_id }}" readonly>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('mobile-money-order-repayment-form');
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('{{ route("mobile_money.debit_wallet") }}', {
            ...
            body: JSON.stringify({
                ...
                remarks: 'Order Re-payment - Order #{{ $order_id }}'
            })
        })
        .then(response => response.json())
        .then(data => {
            if (data.success) {
                alert('{{ translate("Payment completed successfully!") }}');

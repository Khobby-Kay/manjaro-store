<div class="mobile-money-payment-container">
    <div class="text-center">
        <h3>{{ translate('Mobile Money Customer Package Payment') }}</h3>
        <p>{{ translate('Purchase customer package using Mobile Money') }}</p>
    </div>

    <div class="payment-form-container">
        <form id="mobile-money-customer-package-form" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="remarks" name="remarks" 
                       value="Customer Package Payment - Order #{{ $order_id }}" readonly>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('mobile-money-customer-package-form');
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('{{ route("mobile_money.debit_wallet") }}', {
            ...
            body: JSON.stringify({
                ...
                remarks: 'Customer Package Payment - Order #{{ $order_id }}'
            })
        })
        .then(response => response.json())
        .then(data => {

    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0 h6">{{ translate('Affiliate withdraw request')}}</h6>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('affiliate.configs.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('Minimum Affiliate Withdraw Amount')}}</label>
                        </div>
                        <div class="col-lg-8">
                            <input type="number" min="0" step="0.01" max="" class="form-control" name="minimum_affiliate_withdraw_amount" value="{{ $minimum_affiliate_withdraw_amount }}" placeholder="Withdraw Amount" required>
                        </div>
                    </div>

...
use App\Http\Controllers\Payment\PrudentialController;
...
//Prudential Bank
Route::get('/prudential/checkout/testing', [PrudentialController::class, 'checkout_testing'])->name('prudential.checkout.testing');
Route::get('/prudential/wallet/testing', [PrudentialController::class, 'wallet_testing'])->name('prudential.wallet.testing');
Route::get('/prudential/customer_package/testing', [PrudentialController::class, 'customer_package_payment_testing'])->name('prudential.customer_package.testing');
Route::get('/prudential/seller_package/testing', [PrudentialController::class, 'seller_package_payment_testing'])->name('prudential.seller_package.testing');
Route::get('/prudential/callback/testing', [PrudentialController::class, 'callback_testing'])->name('prudential.callback.testing');

// Admin-only Prudential callback monitoring
Route::middleware(['auth', 'admin'])->group(function () {
    Route::get('/prudential/admin/callback/monitor', [PrudentialController::class, 'admin_callback_monitor'])->name('prudential.admin.callback.monitor');
    Route::get('/prudential/admin/callback/test', [PrudentialController::class, 'admin_callback_test'])->name('prudential.admin.callback.test');
});

Route::post('/prudential/create_order', [PrudentialController::class, 'create_order'])->name('prudential.create_order');
Route::any('/prudential/callback', [PrudentialController::class, 'prudential_callback'])->name('prudential.callback');
Route::any('/prudential/return', [PrudentialController::class, 'prudential_return'])->name('prudential.return');
Route::any('/prudential/cancel', [PrudentialController::class, 'prudential_cancel'])->name('prudential.cancel');

//Mobile Money
Route::get('/mobile_money/checkout/testing', [MobileMoneyController::class, 'checkout_testing'])->name('mobile_money.checkout.testing');
Route::get('/mobile_money/wallet/testing', [MobileMoneyController::class, 'wallet_testing'])->name('mobile_money.wallet.testing');
Route::get('/mobile_money/customer_package/testing', [MobileMoneyController::class, 'customer_package_payment_testing'])->name('mobile_money.customer_package.testing');
Route::get('/mobile_money/seller_package/testing', [MobileMoneyController::class, 'seller_package_payment_testing'])->name('mobile_money.seller_package.testing');
Route::get('/mobile_money/callback/testing', [MobileMoneyController::class, 'callback_testing'])->name('mobile_money.callback.testing');

// Admin-only Mobile Money callback monitoring
Route::middleware(['auth', 'admin'])->group(function () {
    Route::get('/mobile_money/admin/callback/monitor', [MobileMoneyController::class, 'admin_callback_monitor'])->name('mobile_money.admin.callback.monitor');
    Route::get('/mobile_money/admin/callback/test', [MobileMoneyController::class, 'admin_callback_test'])->name('mobile_money.admin.callback.test');
});

Route::post('/mobile_money/wallet_name_enquiry', [MobileMoneyController::class, 'wallet_name_enquiry'])->name('mobile_money.wallet_name_enquiry');
Route::post('/mobile_money/debit_wallet', [MobileMoneyController::class, 'debit_wallet'])->name('mobile_money.debit_wallet');
Route::post('/mobile_money/check_transaction_status', [MobileMoneyController::class, 'check_transaction_status'])->name('mobile_money.check_transaction_status');
Route::any('/mobile_money/callback', [MobileMoneyController::class, 'mobile_money_callback'])->name('mobile_money.callback');
Route::any('/mobile_money/return', [MobileMoneyController::class, 'mobile_money_return'])->name('mobile_money.return');
Route::any('/mobile_money/cancel', [MobileMoneyController::class, 'mobile_money_cancel'])->name('mobile_money.cancel');

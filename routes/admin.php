...
use App\Http\Controllers\Admin\StaffActivityLogController;
use App\Http\Controllers\Admin\AlibabaController;
use App\Http\Controllers\Admin\AlibabaSupplierController;
use App\Http\Controllers\Admin\AlibabaProductController;
use App\Http\Controllers\Admin\AlibabaOrderController;
use App\Http\Controllers\Admin\AlibabaImportLogController;
...
Route::get('/admin', [AdminController::class, 'admin_dashboard'])->name('admin.dashboard')->middleware(['auth', 'admin', 'prevent-back-history', 'staff-activity-log']);
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history', 'staff-activity-log']], function () {
    ...
    Route::group(['prefix' => 'staff-activity'], function () {
        ...
        Route::get('/test-log', function() {
            \App\Services\StaffActivityLogService::log('test', 'testing', 'Testing activity logging functionality');
            return response()->json(['message' => 'Activity logged successfully!']);
        })->name('staff_activity_logs.test');
    });

    // Alibaba Module Routes
    Route::group(['prefix' => 'alibaba', 'as' => 'alibaba.'], function () {
        Route::get('/', [AlibabaController::class, 'index'])->name('dashboard');
        Route::get('/settings', [AlibabaController::class, 'settings'])->name('settings');
        Route::post('/settings', [AlibabaController::class, 'updateSettings'])->name('update-settings');
        
        // Suppliers
        Route::resource('suppliers', AlibabaSupplierController::class);
        Route::post('/suppliers/bulk-delete', [AlibabaSupplierController::class, 'bulkDelete'])->name('suppliers.bulk-delete');
        
        // Products
        Route::resource('products', AlibabaProductController::class);
        Route::post('/products/import', [AlibabaProductController::class, 'import'])->name('products.import');
        Route::post('/products/bulk-update-pricing', [AlibabaProductController::class, 'bulkUpdatePricing'])->name('products.bulk-update-pricing');
        Route::post('/products/bulk-import-csv', [AlibabaProductController::class, 'bulkImportCsv'])->name('products.bulk-import-csv');
        Route::post('/products/bulk-import-supplier', [AlibabaProductController::class, 'bulkImportSupplier'])->name('products.bulk-import-supplier');
        Route::post('/products/import-trending', [AlibabaProductController::class, 'importTrending'])->name('products.import-trending');
        Route::post('/products/discover', [AlibabaProductController::class, 'discoverProducts'])->name('products.discover');
        Route::post('/products/import-single', [AlibabaProductController::class, 'importSingleProduct'])->name('products.import-single');
        Route::post('/products/fetch-details', [AlibabaProductController::class, 'fetchDetails'])->name('products.fetch-details');
        Route::post('/products/{product}/sync', [AlibabaProductController::class, 'sync'])->name('products.sync');
        Route::post('/products/{product}/update-pricing', [AlibabaProductController::class, 'updatePricing'])->name('products.update-pricing');
        Route::post('/products/{product}/convert-to-frontend', [AlibabaProductController::class, 'convertToFrontend'])->name('products.convert-to-frontend');
        Route::get('/products/download-template', [AlibabaProductController::class, 'downloadTemplate'])->name('products.download-template');
        
        // Test routes
        Route::get('/products/test', [AlibabaProductController::class, 'test'])->name('products.test');
        
        // Orders
        Route::resource('orders', AlibabaOrderController::class);
        Route::post('/orders/{order}/place-with-supplier', [AlibabaOrderController::class, 'placeWithSupplier'])->name('orders.place-with-supplier');
        Route::post('/orders/sync-statuses', [AlibabaOrderController::class, 'syncStatuses'])->name('orders.sync-statuses');
        Route::post('/orders/{order}/cancel', [AlibabaOrderController::class, 'cancel'])->name('orders.cancel');
        Route::post('/orders/{order}/update-status', [AlibabaOrderController::class, 'updateStatus'])->name('orders.update-status');
        Route::post('/orders/{order}/sync', [AlibabaOrderController::class, 'sync'])->name('orders.sync');
        
        // Import Logs
        Route::get('/import-logs', [AlibabaImportLogController::class, 'index'])->name('import-logs.index');
        Route::get('/import-logs/{log}', [AlibabaImportLogController::class, 'show'])->name('import-logs.show');
        Route::post('/import-logs/clear-old', [AlibabaImportLogController::class, 'clearOld'])->name('import-logs.clear-old');
        Route::post('/import-logs/retry', [AlibabaImportLogController::class, 'retry'])->name('import-logs.retry');
        Route::get('/import-logs/{id}/download', [AlibabaImportLogController::class, 'download'])->name('import-logs.download');
        Route::get('/import-logs/{id}/export-products', [AlibabaImportLogController::class, 'exportProducts'])->name('import-logs.export-products');
        Route::delete('/import-logs/{id}', [AlibabaImportLogController::class, 'destroy'])->name('import-logs.destroy');
        
        // API Testing
        Route::post('/test-api', [AlibabaController::class, 'testApi'])->name('test-api');
        Route::post('/sync-products', [AlibabaController::class, 'syncProducts'])->name('sync-products');
    });
});
